        ...
        <AnimatePresence>
          {mobileOpen && (
            ...
            >
              ...
              <a href={getLoginUrl()} className="block px-3 py-2.5 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50">Sign In</a>
              <a href={getLoginUrl()} className="block px-3 py-3 bg-[#F59E0B] text-white font-bold rounded-xl text-sm text-center mt-2">
                Get Started Free →
              </a>
            </motion.div>
          )}
